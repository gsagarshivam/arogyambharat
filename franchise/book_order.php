...
{*/
  ...
  if(isset($_POST['ok']))
  {
    ...
    {             
        ...
        $q = mysqli_query($conn,"SELECT activation_status FROM `client_account_profile` WHERE client_id = '".$client_id."'");
        $client_det = mysqli_fetch_array($q);
        
        if($client_det['activation_status']==0)
        {
        ...
        if(!empty($_POST['checkbox']))
        {
          ...
          $invoiceinsstatus = mysqli_query($conn,"INSERT INTO `client_invoices` (`entry_type`,`user_id`,`order_by`, `user_type`, `invoice_fy`, `invoice_no`, `invoice_date`, `client_id`, `created_at`, `invoice_type`, `total_amt`, `total_bv`, `invoice_token`, `firstname`, `lastname`, `email`, `telephone`, `address`, `state`, `city`, `country`, `postcode`, `payment_method`) VALUES ( 
          'agent',
          '".iClean($conn,$user_id)."',
          'franchise', 
...
<html lang="en">
<head>
<title> Book Agent Order: <?php echo COMPANY?></title>
...
<?php include("inc/header.php");?>
 ...
 <div class="card">
  <div class="card-body">
    <h4 class="mt-0 header-title">Book Agent Order</h4>
    <hr><br>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group row" style="display: none;">
              <label class="col-md-5 label-control" for="userinput1">Agent Code</label>
              <div class="col-md-7">
            ...
            <div class="form-group row" id="member_code">
              <label class="col-md-3 label-control" for="userinput1">&nbsp;&nbsp;&nbsp;Agent ID</label>
              <div class="col-md-9">
                <input type="text" value="" name="mem_code" id="mem_code" class="form-control" placeholder="Agent Code"/>
