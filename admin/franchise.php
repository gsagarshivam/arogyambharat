            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Franchise Details </a></li>
					</ol>
                </div>
                <div class="row">
                    <div class="col-12">
                                    ...
                                    <table id="example" class="display" style="width:100%">
                                        <thead>
                                            <tr>
                                               ...
                                               <th class="th-sm">Aadhar Card</th>
                                               <th class="th-sm">CWP</th>
                                        ...
                                        <tbody>
                                            <?php
                                               include("conn.php");
                                               $x = "0";
                                               $result_set="SELECT * FROM franchise_htc ORDER BY id DESC";
